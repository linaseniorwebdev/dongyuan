                ...
                <div class="row">
                    ...
                    <ul class="nav nav-tabs center-nav-tabs" role="tablist">
                        <li role="presentation" class="active col-sm-2" style="padding: 0;width: 18%;">
                            <a href="#home" aria-controls="home" role="tab" data-toggle="tab">购物车清单</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="more-goods-body">
                    <table class="table table-responsive">
                        ...
                        <?php
                        if ($carts_rel == null){
                            echo '<td colspan="6" class="text-center">没有购物车。</td>';
                        }else{
                        ...
                        <p class="order-info-title">订购信息</p>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea name="shipping_address" id="" rows="4" class="form-control" placeholder="请输入详细地址"></textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
