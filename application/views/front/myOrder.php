                    ...
                    <table class="table table-responsive table-hover table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                foreach ($orders as $key0=>$item){
                                foreach ($item['detail'] as $key1=>$i){
                                ...
                                <td class="text-center opration">
                                    <button type="button" data-toggle="modal"
                                            data-target=".bd-example-modal-lg<?php echo $key0;?><?php echo $key1?>"
                                            class="btn btn-primary-block">查看</button>
                                </td>
                            </tr>
                            <div class="modal fade bd-example-modal-lg<?php echo $key0;?><?php echo $key1?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-8">
                                                            <p><?php echo $price = $i['amount'] * $i['price'];?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
