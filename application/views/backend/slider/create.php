		...
		<div class="content-body">
			<div class="card">
				<div class="card-content">
					<div class="card-body">
						<form action="<?php echo base_url('api/slider/create'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group row no-gutters">
								...
								<div class="col-10">
									<div class="upload-btn-wrapper">
										...
										<input type="file" name="userfile" onchange="readURL(this);" accept="image/*" required />
										<span>&nbsp;&nbsp;&nbsp;建议图像宽高比应为16:9</span>
									</div>
									<div class="mt-2">
										<img id="preview" src="<?php echo base_url('public/uploads/sliders/noimage.png') ?>" alt="Preview" style="max-width: 500px; margin-left: auto; margin-right: auto; display: block;" />
									</div>
								</div>
							</div>
